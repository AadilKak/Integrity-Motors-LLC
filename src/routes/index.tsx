...
import dealerLogo from "@/assets/integrity-logo.png";
import { useQuery } from "@tanstack/react-query";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Integrity Motors LLC - Used Cars in Harrisburg, PA" },
      { name: "description", content: "Integrity Motors LLC in Harrisburg, PA. Used vehicles, reliable service, clear communication, and straightforward buying." },
      { property: "og:title", content: "Integrity Motors LLC - Harrisburg, PA" },
      { property: "og:description", content: "Used vehicles in Harrisburg, PA with helpful service, clear communication, and a straightforward buying experience." },
    ],
  }),
  component: Index,
});
...
const DEALER_SLUG = import.meta.env.VITE_DEALER_SLUG ?? "integrity-motors-llc";
const DEFAULT_DEALER = {
  name: "Integrity Motors LLC",
  phone: "7176499632",
  address: "2727 Herr St, Harrisburg, PA 17103",
};
    ...
    <div className="page-zoom min-h-screen bg-background pb-20 text-foreground md:pb-0">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-32">
          ...
          <p className="mt-5 max-w-xl text-lg text-muted-foreground">
            Shop used vehicles from a local Harrisburg dealer with reliable service, clear communication, and straightforward buying.
          </p>
          ...
          <div className="mt-10 flex max-w-xl flex-wrap gap-3 text-sm">
            {[
              ...
              { k: "10 AM-6 PM", v: "Mon-Sat" },
              { k: "4.4 stars", v: "Google reviews" },
              { k: "Mon-Sat", v: "Business hours" },
            ].map((s) => (
      ...
      <section className="border-y border-border bg-muted/40">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-2 px-4 py-6 sm:gap-4 sm:px-6 sm:py-8 md:grid-cols-4">
          {[
            { icon: DollarSign, label: "Great Value" },
            { icon: MessageSquare, label: "Easy Contact" },
            { icon: ShieldCheck, label: "Clear Details" },
            { icon: Wrench, label: "Reliable Service" },
          ].map((f) => (
      ...
      <section id="about" className="bg-muted/40 py-20">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h2 className="mt-1 text-3xl font-bold tracking-tight md:text-4xl">Helpful used car buying in Harrisburg</h2>
            <p className="mt-4 text-muted-foreground">
              Integrity Motors LLC is a local used vehicle dealer on Herr St in Harrisburg, PA. The lot focuses on reliable used vehicles, honest communication, and a straightforward buying process.
            </p>
            <p className="mt-4 text-muted-foreground">
              Text, call, or stop by. Tell us what you are looking for and the team will help you check current availability.
            </p>
      ...
      <section id="reviews" className="bg-zinc-950 py-20 text-white">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              { name: "Judah Praise", text: "Very reliable and quality services. I bought an AS IS 09 Camry and everything I was told turned out exactly. I got a great price and I am very satisfied with my purchase. His communication and timeliness in response was phenomenal. I definitely would say that this name Integrity is befitting." },
              { name: "B L", text: "Wonderful seller! Very nice, polite and accommodating. Car is nice!" },
              { name: "Jayson Rice", text: "Very friendly and responsive. The car we came to buy was exactly as described and a great deal. Thanks everyone here!" },
              { name: "Stephen Njau", text: "Quality work done. Satisfied with the brake work to my one car and the other radiator changing and engine leak fix. My walk in was honored. Thank you for your good work." },
              { name: "Dan Shiffka", text: "Great service, price, and communication throughout the repair process. They made it easy. I will be taking my other vehicle there too." },
            ].map((review) => (
              <div
                key={review.name}
      ...
      <footer className="border-t border-border bg-background">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-6 py-6 text-sm text-muted-foreground md:flex-row">
          <div>© {new Date().getFullYear()} {dealerName} · Harrisburg, PA used vehicle dealer</div>
